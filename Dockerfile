...
COPY --chown=algorithm:algorithm effnetb7_weights.pth /opt/algorithm/effnetb7_weights.pth
COPY --chown=algorithm:algorithm inceptionv3_weights.pth /opt/algorithm/inceptionv3_weights.pth
COPY --chown=algorithm:algorithm autoencoder_weights.pth /opt/algorithm/autoencoder_weights.pth
COPY --chown=algorithm:algorithm vae_weights.pth /opt/algorithm/vae_weights.pth
